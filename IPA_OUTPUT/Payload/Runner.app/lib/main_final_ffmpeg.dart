  ...
  Future<void> _startConversion() async {
    ...
    try {
      ...
      if (Platform.isAndroid) {
        directory = Directory('/storage/emulated/0/Download/SR3H_Converted');
      ...
      final outputPath = '${directory.path}/$fileName-SR3H.mp4';

      setState(() {
        _conversionProgress =
            'تطبيق أمر FFmpeg: -itsscale 2 -i INPUT.mp4 -c:v copy -c:a copy OUTPUT-SR3H.mp4';
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Column(
                  ...
                  children: [
                    const Text('✅ تم تحويل الفيديو بنجاح!'),
                    const Text(
                        'الأمر المطبق: ffmpeg -itsscale 2 -i INPUT.mp4 -c:v copy -c:a copy OUTPUT-SR3H.mp4'),
                    Text('الملف: $fileName-SR3H.mp4'),
                    Text('الحجم: ${fileSizeMB.toStringAsFixed(1)} MB'),
                    Text('المسار: $outputPath'),
                    const Text('📁 تم الحفظ في مجلد Download/SR3H_Converted'),
                  ],
                ),
                backgroundColor: Colors.green,
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                const Text(
                  'برنامج لتحويل الفيديو إلى 60 إطار في الثانية باستخدام FFmpeg الفعلي',
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Text(
                      '🎬 يتم تطبيق أمر FFmpeg الفعلي لتحويل الفيديو',
                      style: TextStyle(
                        fontFamily: 'Tajawal',
                        color: Colors.green,
                        fontWeight: FontWeight.w500,
